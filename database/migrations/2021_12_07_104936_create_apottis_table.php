...
class CreateApottisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('OfficeDB')->create('apottis', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('apotti_sequence');
            $table->string('apotti_status',100);
            $table->timestamps();
        });
    }
