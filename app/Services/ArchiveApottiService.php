    ...
    public function migrateArchiveApottiToAmms(Request $request)
    {
        ...
        try {
            ...
            $office_ac_memo_data = [
                ...
                'parent_office_id' => $memo->entity_info_id ?: 0,
                'parent_office_name_en' => $memo->entity_name_en ?: 'undefined parent',
                'parent_office_name_bn' => $memo->entity_name_bn ?: 'undefined parent',
